...
export function registerWriteTools(
  ...
  server.tool(
    ...
    "Send a new email message via iCloud Mail",
    {
      ...
      from: z.string().optional().describe("Send from this address (must be an alias configured on your iCloud account, e.g. me@yourdomain.com). Defaults to primary iCloud email."),
      fromName: z.string().optional().describe("Display name for the From header (e.g. 'Jane Doe'). If omitted, sends with bare address."),
